...
export function calcX(radius, minutes) {
  var minutes_in_rads = toRadians(minutes * 6);
  return Math.cos(minutes_in_rads) * radius;
}

export function calcY(radius, minutes) {
  var minutes_in_rads = toRadians(minutes * 6);
  return Math.sin(minutes_in_rads) * radius;
}
